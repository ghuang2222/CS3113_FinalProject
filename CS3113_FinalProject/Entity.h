...
private:
    ...
    AnimationDirection m_facing = RIGHT;
    // ————— TRANSFORMATIONS ————— //
    glm::vec3 m_movement;
    glm::vec3 m_position;
    ...
    bool m_is_jumping;
    bool m_enemy_in_range = false;
    float m_bullet_distance;
    float m_reload_time = 1.0f;
...
public:
    ...
    void face_left() { m_animation_indices = m_walking[LEFT]; m_facing = LEFT; }
    void face_right() { m_animation_indices = m_walking[RIGHT]; m_facing = RIGHT; }
    ...
    glm::vec3 const get_init_position() const { return m_init_position; }
    ...
    bool      const get_collided_any() const { return m_collided_top || 
                                                      m_collided_right || 
                                                      m_collided_left ||
                                                    m_collided_bottom;
                                                }
    bool      const get_is_active() const { return m_is_active; }
    AnimationDirection const get_facing() const { return m_facing; }
    float     const get_health() const { return m_health; }
    float     const get_damage() const { return m_damage; }
    Entity* const get_bullet() const { return m_bullet; }
    ...
    void const set_bullet_distance(float new_dist) { m_bullet_distance = new_dist; }
    void const set_bullet(Entity* bullet, unsigned int& bullet_idx, const int bullet_count);
    void const set_health(float new_health) { m_health = new_health; }
    void const set_damage(float new_damage) { m_damage= new_damage; }
